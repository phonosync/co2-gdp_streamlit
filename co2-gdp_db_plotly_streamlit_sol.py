...
st.dataframe(co2_extremes[['type', 'country', 'region', 'year', 'co2', 'gdp']], use_container_width=True,hide_index=True)
...
st.dataframe(gdp_extremes[['type', 'country', 'region', 'year', 'gdp', 'co2']], use_container_width=True, hide_index=True)
...
with col1:
    ...
    st.plotly_chart(fig_co2_slope, use_container_width=True)
...
with col2:
    ...
    st.plotly_chart(fig_gdp_slope, use_container_width=True)
...
with col1:
    ...
    st.plotly_chart(fig_co2_region, use_container_width=True)
